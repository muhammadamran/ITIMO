...
?>
<title>Allocate Headphones Summary - <?= $Rapps['app_name'] ?> | General Management</title>
            ...
            <div class="container-fluid dashboard-content ">
                        ...
                        <div class="page-header">
                            <div class="c-page">
                                ...
                                <div style="margin-left: 10px;">
                                    <div>
                                        <h2 class="pageheader-title" style="color: #003369;">Allocate Headphones Summary </h2>
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="headphones_summary.php" class="btn btn-primary"><i class="fas fa-caret-square-left"></i> Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <h5 class="card-header">
                                ...
                                <select id="IdSelectBy" style="border-color: transparent;background: #003369;color: #fff;border-radius: 10px;font-size: 12px;">
                                    ...
                                    <option value="VHeadphones">Headphones</option>
                                </select>
                            </h5>
                            <div class="card-body">
                                <div id="FormUser" style="display:none">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" style="margin-bottom: 18px;">
                                                <select name="SerialNumberOne" id="IdSerialNumberOne" onchange="ShowSNOne(this.value)">
                                                    ...
                                                    <?php
                                                    $dataSNOne = $db->query("SELECT * FROM tb_headphones_master ORDER BY id ASC");
                                    ...
                                    <form action="headphones_summary.php" method="POST" enctype="multipart/form-data">
                                        <fieldset>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="row">
                                                ...
                                                <div class="col-sm-12" style="display: flex;justify-content: flex-end;">
                                                    <a href="javascript:;" onclick="window.open('headphones_summary.php', '_self', ''); window.close();" class="btn btn-light" data-dismiss="modal" style="margin-right: 5px;"><i class="fas fa-times-circle"></i> Close</a>
                                ...
                                <div id="FormHeadphones" style="display:none">
                                    <div class="row" style="display: flex;justify-content: flex-start;align-items: end;margin-top: 5px;">
                                        <div>
                                            <div style="font-size: 15px;margin-bottom: 10px;margin-top: -25px;background: #003369;border-radius: 10px;margin-left: 15px;color: #fff;padding: 10px;">
                                                <i class="fas fa-headphones-alt"></i> HEADPHONES
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group" style="margin-bottom: 18px;">
                                                <select name="SerialNumberTwo" id="IdSerialNumberTwo" onchange="ShowSNTwo(this.value)">
                                                    <option value="">Choose Serial Number</option>
                                                    <?php
                                                    $dataSNTwo = $db->query("SELECT * FROM tb_headphones_master ORDER BY id ASC");
                                    ...
                                    <form action="headphones_summary.php" method="POST" enctype="multipart/form-data">
                                        <fieldset>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12" style="display: flex;justify-content: flex-end;">
                                                    <a href="javascript:;" onclick="window.open('headphones_summary.php', '_self', ''); window.close();" class="btn btn-light" data-dismiss="modal" style="margin-right: 5px;"><i class="fas fa-times-circle"></i> Close</a>
                                                    <button type="submit" name="newhostname_" class="btn btn-primary"><i class="fas fa-headphones-alt"></i> Update</button>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </form>
...
<script type="text/javascript">
    ...
    $(function() {
        $("#IdNewUsername").autocomplete({
            source: 'function/autocomplete/data_headphones.php?function=AutoUsername'
        });
    });
    ...
    function ShowSNOne(sn_one) {
        ...
        xmlhttp.open("GET", "function/function_get_headphones.php/get_sn_one?function=SNone&sn_one=" + sn_one, true);
        xmlhttp.send();
    }
    ...
    function ShowSNTwo(sn_two) {
        ...
        xmlhttp.open("GET", "function/function_get_headphones.php/get_sn_two?function=SNtwo&sn_two=" + sn_two, true);
        xmlhttp.send();
    }
