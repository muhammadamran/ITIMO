        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $uriSegments[2] == 'references_functional.php' || $uriSegments[2] == 'references_department.php' || $uriSegments[2] == 'references_branch.php' || $uriSegments[2] == 'references_positions.php' ? 'active' : '' ?>" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-setup" aria-controls="submenu-14">
                            <i class="fas fa-asterisk" id="sidebar-font"></i>
                            <span>References</span>
                        </a>
                        <div id="submenu-setup" class="collapse submenu <?= $uriSegments[2] == 'references_functional.php' || $uriSegments[2] == 'references_department.php' || $uriSegments[2] == 'references_branch.php' || $uriSegments[2] == 'references_positions.php' ? 'show' : '' ?>">
                            <ul class="nav flex-column">
                                <!-- <li class="nav-item">
