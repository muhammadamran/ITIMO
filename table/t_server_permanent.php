<table id="dataTablesN" class="table table-striped table-bordered first">
    ...
    <tbody>
        <?php
        $dataTable = $db->query("SELECT * FROM tb_server_master WHERE status_available='PERMANENT' ORDER BY id DESC", 0);
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">[Asset Data] Server</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="doc-asset">
                                                    ...
                                                    <div style="margin-top: -101px;display: flex;justify-content: center;margin-bottom: 0px;">
