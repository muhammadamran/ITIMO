    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <div style="display: flex;justify-content: center;align-items: center;">
                            <a href="headphones_summary_edit.php?ID=<?= $row['id']; ?>" class="btn btn-sm btn-behind-green" data-container="body" data-trigger="hover" data-toggle="popover" data-placement="left" data-content="Edit Device: <?= $row['serial_number']; ?>" style="margin-left: 5px;">
                ...
                <div class="modal fade" id="Delete<?= $row['id']; ?>">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">[Delete Data] Headphones</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            </div>
                            <form action="" method="POST">
                                <div class="modal-body">
