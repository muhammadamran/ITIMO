        ...
        ?>
                <tr>
                    ...
                    <td>
                        <div style="display: flex;justify-content: center;align-items: center;">
                            <div>
                                <a href="phone_summary_history.php?SN=<?= $row['serial_number']; ?>" data-container="body" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Detail Device History: <?= $row['serial_number']; ?>">
                    ...
                    <td>
                        <div style="display: flex;justify-content: center;align-items: center;">
                            <a href="phone_summary_edit.php?ID=<?= $row['id']; ?>" class="btn btn-sm btn-behind-green" data-container="body" data-trigger="hover" data-toggle="popover" data-placement="left" data-content="Edit Device: <?= $row['serial_number']; ?>" style="margin-left: 5px;">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">[Asset Data] Phone</h4>
                                                            ...
                                                            <div class="carousel-inner">
                                                                ...
                                                                ?>
                                                                    <div class="carousel-item <?= $s ?>">
                                                                        <img class="d-block w-100" src="assets/images/handover/phone/<?= $dataP ?>" alt="<?= $dataP ?>">
                                                                    </div>
                                                                <?php $i++;
                                                                } ?>
                                                            </div>
                ...
                <div class="modal fade" id="Delete<?= $row['id']; ?>">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">[Delete Data] Phone</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            </div>
                            <form action="" method="POST">
                                <div class="modal-body">
