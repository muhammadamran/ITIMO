                                        ...
                                        <div class="row" style="align-items: center;">
                                            <div class="col-sm-3">
                                                <div class="doc-asset">
                                                    ...
                                                    <div style="margin-top: -135px;display: flex;justify-content: center;margin-bottom: 0px;">
                                                            ...
                                                            <div class="carousel-inner">
                                                                ...
                                                                ?>
                                                                    <div class="carousel-item <?= $s ?>">
                                                                        <img class="d-block w-100" src="assets/images/handover/monitor/<?= $dataP ?>" alt="<?= $dataP ?>">
                                                                    </div>
                                                                <?php $i++;
                                                                } ?>
                                                            </div>
