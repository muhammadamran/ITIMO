...
if (isset($_POST["import_"])) {
    if (isset($_FILES["ImportXLS"])) {
        ...
        echo "<script>window.location.href='pc_summary.php?UploadFailed=true&page=$page';</script>";
    }
}
// Add
if (isset($_POST["add_"])) {
    ...
    for ($i = 0; $i < $countfiles; $i++) {
        $filename = "PC_handover_" . $SerialNumber . "_" . date('Ymd') . "." . $_FILES['file']['name'][$i];
        move_uploaded_file($_FILES['file']['tmp_name'][$i], 'assets/images/handover/pc/' . $filename);
    }
    $fileName = $_FILES['file']['name'];
    foreach ($fileName as $rowfile) {
        $FileH .= "PC_handover_" . $SerialNumber . "_" . date('Ymd') . "." . $rowfile . ",";
    }
    // End Pictures
    ...
    if (mysqli_num_rows($available) == 1) {
        ...
        $insert = $db->query("INSERT INTO tb_pc_master
                            ...
                            VALUES
                            ('','PC','$SerialNumber','$ProductName','$Brand','$DeviceRelease','$Memory','$DiskSpace','$DiskType','$Processor','$Hostname','$Username','$UsageState','$OwnershipStatus','$BranchLocation','$RoomLocation','$PONumber','$CC','$AssetNumber','$Assetof','$PurchaseYear','$PurchaseBatch','$Prices','$Remarks','$created_by','$created_date','$FileH')
                            ");

        if ($insert) {
            echo "<script>window.location.href='pc_summary.php?InsertSuccess=true&page=$page';</script>";
        } else {
            echo "<script>window.location.href='pc_summary.php?InsertFailed=true&page=$page';</script>";
        }
    }
}
// Edit
if (isset($_POST["edit_"])) {
    ...
    if ($edit) {
        echo "<script>window.location.href='pc_summary.php?UpdateSuccess=true&page=$page';</script>";
    } else {
        echo "<script>window.location.href='pc_summary.php?UpdateFailed=true&page=$page';</script>";
    }
}
// Delete
if (isset($_POST["delete_"])) {
    ...
    if ($delete) {
        ...
        echo "<script>window.location.href='pc_summary.php?DeleteFailed=true&page=$page';</script>";
    }
}
// new username
...
?>
<title>PC Summary - <?= $Rapps['app_name'] ?> | General Management</title>
        ...
        <div class="dashboard-ecommerce">
            <div class="container-fluid dashboard-content ">
                        ...
                        <div class="page-header">
                            <div class="c-page">
                                ...
                                <div style="margin-left: 10px;">
                                    <div>
                                        <h2 class="pageheader-title" style="color: #003369;">PC Summary </h2>
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header"><i class="fas fa-filter"></i> Filter Data PC Summary</h5>
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div style="display: flex;justify-content: space-between;align-items: center;">
                                <div>
                                    <h5 class="card-header-custom">
                                        <i class="fas fa-list"></i> Data PC Summary <br><small>Read Information</small>
                                        <!-- Info -->
                                ...
                                <div>
                                    <div class="card-header-custom">
                                        <a href="pc_summary_allocate.php" class="btn btn-sm btn-primary" title="Allocate Device">
                                            ...
                                            &nbsp; OR &nbsp;
                                            <i class="fas fa-phone" data-container="body" data-trigger="hover" data-toggle="popover" data-placement="top" data-content="Change Hostname"></i>
                                        </a>
                                        <!-- Download Template -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <?php include "table/t_pc_summary.php"; ?>
                                </div>
                            </div>
                        </div>
                    </div>
