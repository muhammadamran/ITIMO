...
?>
<title>Allocate RF Scanner Summary - <?= $Rapps['app_name'] ?> | General Management</title>
            ...
            <div class="container-fluid dashboard-content ">
                        ...
                        <div class="page-header">
                            <div class="c-page">
                                ...
                                <div style="margin-left: 10px;">
                                    <div>
                                        <h2 class="pageheader-title" style="color: #003369;">Allocate RF Scanner Summary </h2>
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="scanner_summary.php" class="btn btn-primary"><i class="fas fa-caret-square-left"></i> Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <h5 class="card-header">
                                ...
                                <select id="IdSelectBy" style="border-color: transparent;background: #003369;color: #fff;border-radius: 10px;font-size: 12px;">
                                    ...
                                    <option value="VRFScanner">RF Scanner</option>
                                </select>
                            </h5>
                            <div class="card-body">
                                <div id="FormUser" style="display:none">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" style="margin-bottom: 18px;">
                                                <select name="SerialNumberOne" id="IdSerialNumberOne" onchange="ShowSNOne(this.value)">
                                                    ...
                                                    <?php
                                                    $dataSNOne = $db->query("SELECT * FROM tb_scanner_master ORDER BY id ASC");
                                    ...
                                    <form action="scanner_summary.php" method="POST" enctype="multipart/form-data">
                                        <fieldset>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="row">
                                ...
                                <div id="FormRFScanner" style="display:none">
                                    <div class="row" style="display: flex;justify-content: flex-start;align-items: end;margin-top: 5px;">
                                        <div>
                                            <div style="font-size: 15px;margin-bottom: 10px;margin-top: -25px;background: #003369;border-radius: 10px;margin-left: 15px;color: #fff;padding: 10px;">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" style="margin-bottom: 18px;">
                                                <select name="SerialNumberTwo" id="IdSerialNumberTwo" onchange="ShowSNTwo(this.value)">
                                                    <option value="">Choose Serial Number</option>
                                                    <?php
                                                    $dataSNTwo = $db->query("SELECT * FROM tb_scanner_master ORDER BY id ASC");
