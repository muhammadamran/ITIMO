                            ...
                            <div style="display: flex;justify-content: space-between;align-items: center;">
                                ...
                                <div>
                                    <div class="card-header-custom">
                                        ...
                                        <!-- Download Template -->
                                        <a href="files/template/server/template_laptop_master.xls" target="_blank" class="btn btn-sm btn-primary" title="Download Template"><i class="fas fa-file-download"></i>
