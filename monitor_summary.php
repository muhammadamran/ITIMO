...
if (isset($_POST["add_"])) {
    ...
    if (mysqli_num_rows($available) == 1) {
        ...
        $insert = $db->query("INSERT INTO tb_server_master
                            ...
                            VALUES
                            ('','SERVER','$SerialNumber','$ProductName','$Brand','$DeviceRelease','$Memory','$DiskSpace','$DiskType','$Processor','$Hostname','$Username','$UsageState','$OwnershipStatus','$BranchLocation','$RoomLocation','$PONumber','$CC','$AssetNumber','$Assetof','$PurchaseYear','$PurchaseBatch','$Prices','$Remarks','$created_by','$created_date')
                            ");
