...
?>
<title>Headphones Available - <?= $Rapps['app_name'] ?> | General Management</title>
                        ...
                        <div class="page-header">
                            <div class="c-page">
                                ...
                                <div style="margin-left: 10px;">
                                    <div>
                                        <h2 class="pageheader-title" style="color: #003369;">Headphones Available </h2>
                                    </div>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Headphones Available</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div style="display: flex;justify-content: space-between;align-items: center;">
                                <div>
                                    <h5 class="card-header-custom">
                                        <i class="fas fa-list"></i> Data Headphones Available <br><small>Read Information</small>
                                        <!-- Info -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <?php include "table/t_headphones_available.php"; ?>
                                </div>
                            </div>
                        </div>
                    </div>
