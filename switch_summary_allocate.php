...
?>
<title>Allocate Switch Summary - <?= $Rapps['app_name'] ?> | General Management</title>
                        ...
                        <div class="page-header">
                            <div class="c-page">
                                ...
                                <div style="margin-left: 10px;">
                                    <div>
                                        <h2 class="pageheader-title" style="color: #003369;">Allocate Switch Summary </h2>
                                    </div>
                        ...
                        <div class="card">
                            <h5 class="card-header">
                                ...
                                <select id="IdSelectBy" style="border-color: transparent;background: #003369;color: #fff;border-radius: 10px;font-size: 12px;">
                                    ...
                                    <option value="VSwitch">Switch</option>
                                </select>
                            </h5>
                            <div class="card-body">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" style="margin-bottom: 18px;">
                                                <select name="SerialNumberOne" id="IdSerialNumberOne" onchange="ShowSNOne(this.value)">
                                                    ...
                                                    <?php
                                                    $dataSNOne = $db->query("SELECT * FROM tb_switch_master ORDER BY id ASC");
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" style="margin-bottom: 18px;">
                                                <select name="SerialNumberTwo" id="IdSerialNumberTwo" onchange="ShowSNTwo(this.value)">
                                                    <option value="">Choose Serial Number</option>
                                                    <?php
                                                    $dataSNTwo = $db->query("SELECT * FROM tb_switch_master ORDER BY id ASC");
                                    ...
                                    <form action="switch_summary.php" method="POST" enctype="multipart/form-data">
                                        <fieldset>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12" style="display: flex;justify-content: flex-end;">
                                                    <a href="javascript:;" onclick="window.open('switch_summary.php', '_self', ''); window.close();" class="btn btn-light" data-dismiss="modal" style="margin-right: 5px;"><i class="fas fa-times-circle"></i> Close</a>
                                                    <button type="submit" name="newhostname_" class="btn btn-primary"><i class="fas fa-network-wired"></i> Update</button>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </form>
...
<script type="text/javascript">
    ...
    $(function() {
        $("#IdNewUsername").autocomplete({
            source: 'function/autocomplete/data_switch.php?function=AutoUsername'
        });
    });
    ...
    function ShowSNOne(sn_one) {
        ...
        xmlhttp.open("GET", "function/function_get_switch.php/get_sn_one?function=SNone&sn_one=" + sn_one, true);
        xmlhttp.send();
    }
    ...
    function ShowSNTwo(sn_two) {
        ...
        xmlhttp.open("GET", "function/function_get_switch.php/get_sn_two?function=SNtwo&sn_two=" + sn_two, true);
        xmlhttp.send();
    }
