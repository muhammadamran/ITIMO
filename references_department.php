...
if (isset($_POST["add_branch"])) {
    ...
    if (mysqli_num_rows($available) == 1) {
        ...
        if ($insert) {
            echo "<script>window.location.href='references_department.php?InsertSuccess=true&page=$page';</script>";
        } else {
            echo "<script>window.location.href='references_department.php?InsertFailed=true&page=$page';</script>";
        }
    }
}
// Edit
if (isset($_POST["edit_branch"])) {
    ...
    if ($edit) {
        echo "<script>window.location.href='references_department.php?UpdateSuccess=true&page=$page';</script>";
    } else {
        echo "<script>window.location.href='references_department.php?UpdateFailed=true&page=$page';</script>";
    }
}
// Delete
if (isset($_POST["delete_branch"])) {
    ...
    $delete    = $db->query("DELETE FROM references_department WHERE id='$ID'");

    if ($delete) {
        echo "<script>window.location.href='references_department.php?DeleteSuccess=true&page=$page';</script>";
    } else {
        echo "<script>window.location.href='references_department.php?DeleteFailed=true&page=$page';</script>";
    }
}
?>
        ...
        <div class="dashboard-ecommerce">
            <div class="container-fluid dashboard-content ">
                        ...
                        <div class="page-header">
                            <div class="c-page">
                                ...
                                <div style="margin-left: 10px;">
                                    <div>
                                        <h2 class="pageheader-title" style="color: #003369;">Department </h2>
                                    </div>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Department</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header"><i class="fas fa-list"></i> Data Department</h5>
                            <?php include "modal/m_references_department.php"; ?>
                            <hr />
                            <div class="card-body">
                                <div class="table-responsive">
                                    <?php include "table/t_references_department.php"; ?>
                                </div>
                            </div>
                        </div>
                    </div>
