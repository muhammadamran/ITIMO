...
$GET        =  $_GET['SN'];
$dataMaster = $db->query("SELECT * FROM tb_phone_master WHERE serial_number='$GET'");
$resultdM   = mysqli_fetch_array($dataMaster);
?>
<title>History Phone Summary [<?= $resultdM['serial_number']; ?>] - <?= $Rapps['app_name'] ?> | General Management</title>
                        ...
                        <div class="page-header">
                            <div class="c-page">
                                ...
                                <div style="margin-left: 10px;">
                                    <div>
                                        <h2 class="pageheader-title" style="color: #003369;">History Phone: <?= $resultdM['serial_number']; ?> </h2>
                                    </div>
                            ...
                            <div class="card-body">
                                <section class="cd-timeline js-cd-timeline">
                                    <div class="cd-timeline__container">
                                        ...
                                        <!-- End Data Master -->
                                        <?php
                                        $dataTable = $db->query("SELECT * FROM tb_phone_history WHERE serial_number='$GET' ORDER BY id DESC", 0);
                                                ...
                                                <div class="cd-timeline__block js-cd-block">
                                                    <div class="cd-timeline__img cd-timeline__img--picture js-cd-img">
                                                        ...
                                                        <?php } else if ($row['status_history'] == 'Change Hostname') { ?>
                                                            <img src="assets/vendor/timeline/img/smartphone.png" alt="Picture">
                                                        <?php } ?>
                                                    </div>
                                                    <div class="cd-timeline__content js-cd-content">
